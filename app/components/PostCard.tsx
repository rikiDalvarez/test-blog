	...
	return (
		<div className=" bg-orange-200 shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 mt-10 shadow-green-800 ring-green-900	 ring ring-offset-2">
			...
			<h1 className="transition duration-200 text-center mb-8 cursor-pointer
											 text-3xl hover:text-green-300 font-semibold">
			...
			<div className="bloc lg:flex text-center items-center justify-center mb-8 w-full">
				<div className=" flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
					<img src={post.author.photo.url} alt={post.author.name} height="30px" width="30pxs" className=" align-middle rounded-full" />
